 ...
 * @author Bryan
 */
public class InicioAdministra extends javax.swing.JFrame {

    /**
     * Creates new form ContribuyentesPrincipal
     */
    ArrayList<Proveedor> Lis;
    public InicioAdministra() {
        initComponents();
...
Login login = new Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioAdministra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioAdministra().setVisible(true);
            }
        });
    }
