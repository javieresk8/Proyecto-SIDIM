...
public class EditarProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuardarEdiccionProveedor = new javax.swing.JButton();
        ...
        jLabel4.setText("Actualizar Proveedor.");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(163, 164, 166));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("LLene el formulario para actualizar un Proveedor");
        ...
        btnGuardarEdiccionProveedor.setBackground(new java.awt.Color(38, 35, 36));
        btnGuardarEdiccionProveedor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnGuardarEdiccionProveedor.setForeground(new java.awt.Color(240, 240, 241));
        btnGuardarEdiccionProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconosProveedor/diskette_save_saveas_1514.png"))); // NOI18N
        btnGuardarEdiccionProveedor.setText("Guardar");
        btnGuardarEdiccionProveedor.setBorderPainted(false);
        btnGuardarEdiccionProveedor.setFocusPainted(false);
        btnGuardarEdiccionProveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGuardarEdiccionProveedorActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(202, 202, 202)
                        .addComponent(btnGuardarEdiccionProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnGuardarEdiccionProveedor)
                        .addGap(51, 51, 51))))
        );
    ...
    private void btnGuardarEdiccionProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarEdiccionProveedorActionPerformed
       ...
       if (!(txtDireccionProveedor.getText().equals("Dirección del Proveedor"))){
        ...
        if ((correo.isEmpty())||(Direccion.isEmpty())||(telefono.isEmpty())||(contacto.isEmpty())){
            JOptionPane.showMessageDialog(null, "Complete todos los campos ");
        }
        else if(!((correo.isEmpty())&&(Direccion.isEmpty())&&(telefono.isEmpty())&&(contacto.isEmpty()))){
            ...
            limpiar();
            ProveedoresListar Lista = new ProveedoresListar();
    ...
    }//GEN-LAST:event_btnGuardarEdiccionProveedorActionPerformed
    ...
    private void txtRucProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtRucProveedorFocusLost
            ...
            txtRucProveedor.setText("RUC del Proveedor");
        }
    ...
    private void txtRazonSocialProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtRazonSocialProveedorFocusLost
        if(txtRazonSocialProveedor.getText().equals("")){
            txtRazonSocialProveedor.setText("Razón Social del Proveedor");
        }
    ...
    private void txtDireccionProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDireccionProveedorFocusLost
        if(txtDireccionProveedor.getText().equals("")){
            txtDireccionProveedor.setText("Dirección del Proveedor");
        }
    ...
    private void txtCorreoProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCorreoProveedorFocusLost
        if(txtCorreoProveedor.getText().equals("")){
            txtCorreoProveedor.setText("Correo Electronico del Proveedor");
        }
    ...
    private void txtTelefonoProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTelefonoProveedorFocusLost
        if(txtTelefonoProveedor.getText().equals("")){
            txtTelefonoProveedor.setText("Teléfono del Proveedor");
        }
    ...
    private void txtPersonaContactoProveedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPersonaContactoProveedorFocusLost
        if(txtPersonaContactoProveedor.getText().equals("")){
            txtPersonaContactoProveedor.setText("Persona de Contacto del Proveedor");
        }
    ...
    private javax.swing.JButton btnGuardarEdiccionProveedor;
