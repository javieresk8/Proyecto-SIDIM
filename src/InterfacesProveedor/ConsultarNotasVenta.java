 ...
 * @author Bryan
 */
public class ConsultarNotasVenta extends javax.swing.JFrame {

    /**
     * Creates new form ContribuyentesPrincipal
     */
    ArrayList<Proveedor> Lis;
    public ConsultarNotasVenta() {
        initComponents();
...
//    ProveedorRegistrar registroProveedor = new ProveedorRegistrar();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Aquí encuentra las notas de venta en las que participa un Proveedor.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarNotasVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarNotasVenta().setVisible(true);
            }
        });
    }
