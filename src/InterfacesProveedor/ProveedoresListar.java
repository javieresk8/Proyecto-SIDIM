 ...
 * @author Bryan
 */
public class ProveedoresListar extends javax.swing.JFrame {

    /**
     * Creates new form ContribuyentesPrincipal
     */
    ArrayList<Proveedor> Lis;
    public ProveedoresListar() {
        initComponents();
    ...
    boolean bandera = false;
     public void verProveedores(){
        ...
        for (int i =0 ; i<Lis.size();i++){
            aux = Lis.get(i);
            Mat[i][0]= aux.getRUC();
            Mat[i][1]= aux.getRazon_Social();
            Mat[i][2]= aux.getDireccion();
            Mat[i][3]= aux.getCorreo();
            Mat[i][4]= aux.getTelefono();
            Mat[i][5]= aux.getContacto();
            ...
            new String [] {
                "RUC DEL PROVEEDOR", "RAZÓN SOCIAL", "DIRECCIÓN", "CORREO ELECTRÓNICO", "TELEFÓNO", "PERSONA DE CONTACTO"
            }
        ));
        }
    }
...
//    ProveedorRegistrar registroProveedor = new ProveedorRegistrar();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Listado de Proveedores.");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(163, 164, 166));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Aqui encuentra todos los Proveedores que se encuentran registrados.");
        ...
        btnEditarProveedor.setBackground(new java.awt.Color(38, 35, 36));
        btnEditarProveedor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnEditarProveedor.setForeground(new java.awt.Color(240, 240, 241));
        btnEditarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconosProveedor/edit-validated_40458.png"))); // NOI18N
        ...
        btnEliminarProveedor.setBackground(new java.awt.Color(38, 35, 36));
        btnEliminarProveedor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnEliminarProveedor.setForeground(new java.awt.Color(240, 240, 241));
        btnEliminarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconosProveedor/Button_Delete-01_25095.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnEditarProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(258, 258, 258))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(37, 37, 37)
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(382, 382, 382)
                    .addComponent(btnEliminarProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEliminarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarProveedorActionPerformed
        if( JOptionPane.showConfirmDialog(null, "¿Esta seguro que desea Eliminar este Proveedor?", "Alerta!", JOptionPane.YES_NO_OPTION)==YES_OPTION)
        {
            int filaSeleccionada = tblListadoProveedor.getSelectedRow();
            System.out.println(filaSeleccionada);
            if(filaSeleccionada>=0){
                DefaultTableModel modelo = (DefaultTableModel)tblListadoProveedor.getModel();
                modelo.removeRow(filaSeleccionada);
                tblListadoProveedor.setModel(modelo);
                
                JOptionPane.showMessageDialog(null,"El Proveedor a sido eliminado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedoresListar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedoresListar().setVisible(true);
            }
        });
    }
