 ...
 * @author Bryan
 */
public class DeclaracionesDeclarVer extends javax.swing.JFrame {

    /**
     * Creates new form ContribuyentesPrincipal
     */
    public DeclaracionesDeclarVer() {
        initComponents();
    ...
    private void jButNuevaDeclarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButNuevaDeclarActionPerformed
        ...
        if (periodoFiscal.isEmpty()) {
            ...
            DeclaracionesDeclarVer nueva = new DeclaracionesDeclarVer();
...
Login login = new Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeclaracionesDeclarVer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeclaracionesDeclarVer().setVisible(true);
            }
        });
    }
