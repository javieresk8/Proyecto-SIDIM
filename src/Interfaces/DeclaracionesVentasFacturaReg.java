 ...
 * @author Bryan
 */
public class DeclaracionesVentasFacturaReg extends javax.swing.JFrame {
     ...
     */
    public DeclaracionesVentasFacturaReg() {
        initComponents();
       ...
       TextPrompt fechPlHol= new TextPrompt("AAA/MM/DD", jTextFechVenFact);
       TextPrompt rucPlHol= new TextPrompt("RUC de la factura", jTextRucVenFact);
       TextPrompt razSocPlHol= new TextPrompt("Nombre del cliente de la factura", jTextRazCliVenFact);
       TextPrompt numFactPlHol= new TextPrompt("Número de la factura", jTextNumFacVenFact);
       TextPrompt base12PlHol= new TextPrompt("Valor de la base 12% de la factura", jTextBase12VenFact);
       TextPrompt base0PlHol= new TextPrompt("Valor de la base 0% de la factura", jTextBase0VenFact);
       
         
       cmbTipoVentaVentFact.setEnabled(false);
       jTextRucVenFact.setEnabled(false);
       jTextRazCliVenFact.setEnabled(false);
       jTextNumFacVenFact.setEnabled(false);
       jTextBase12VenFact.setEnabled(false);
       jTextBase0VenFact.setEnabled(false);
       jButRegFactVen.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jButRegNotasCred = new javax.swing.JButton();
        jButVerTodNotasCred = new javax.swing.JButton();
        ...
        jButRegNotasCred.setBackground(new java.awt.Color(85, 85, 85));
        jButRegNotasCred.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButRegNotasCred.setForeground(new java.awt.Color(240, 240, 241));
        jButRegNotasCred.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/iconAdd24x24.png"))); // NOI18N
        jButRegNotasCred.setText("Registrar");
        jButRegNotasCred.setBorderPainted(false);
        jButRegNotasCred.setFocusPainted(false);
        jButRegNotasCred.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButRegNotasCredActionPerformed(evt);
            }
        });

        jButVerTodNotasCred.setBackground(new java.awt.Color(85, 85, 85));
        jButVerTodNotasCred.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButVerTodNotasCred.setForeground(new java.awt.Color(240, 240, 241));
        jButVerTodNotasCred.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/iconList24x24.png"))); // NOI18N
        jButVerTodNotasCred.setText("Ver Todos");
        jButVerTodNotasCred.setBorderPainted(false);
        jButVerTodNotasCred.setFocusPainted(false);
        jButVerTodNotasCred.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButVerTodNotasCredActionPerformed(evt);
            }
        });
        ...
        jPanOpcNotasVentaLayout.setHorizontalGroup(
            ...
            .addComponent(jButRegNotasCred, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(jButVerTodNotasCred, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        jPanOpcNotasVentaLayout.setVerticalGroup(
            jPanOpcNotasVentaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanOpcNotasVentaLayout.createSequentialGroup()
                .addComponent(jButRegNotasCred, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButVerTodNotasCred, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jLabel5.setText("Llena el formulario para registrar una Factura en Ventas.");
        ...
        jButRegFactVen.setText("Registrar");
        ...
        cmbTipoVentaVentFact.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar--", "Ventas General", "Anulado", "Ventas Activos Fijos 12%", "Ventas Activos Fijos 0%", "Reembolsos" }));
        ...
        cmbPorcRetVentaFact.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0", "30", "70", "100" }));
        ...
        cmbRetFuenVentaFact.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0", "1", "1", "1.75", "2", "2.75", "8", "10" }));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PanelVerTodosLayout.createSequentialGroup()
                        .addGroup(PanelVerTodosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PanelVerTodosLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jIVA, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(51, 51, 51))
        );
...
Login login = new Login();
    ...
    private void jButVerTodNotasCredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButVerTodNotasCredActionPerformed
        DeclaracionesVentasNotaCreditoList lista = new DeclaracionesVentasNotaCreditoList();
        lista.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButVerTodNotasCredActionPerformed

    private void jButRegNotasCredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButRegNotasCredActionPerformed
         DeclaracionesVentasNotaCreditoReg registrar = new DeclaracionesVentasNotaCreditoReg();
       registrar.setVisible(true);
       this.setVisible(false);
    }//GEN-LAST:event_jButRegNotasCredActionPerformed
    ...
    private void jButRegFactVenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButRegFactVenActionPerformed
        ...
        String query = "INSERT INTO FacturaVentas(idContribuyente, fecha, tipoVenta,ruc,razonSocialCliente, numeroFacturaVentas, base12,iva,base0,total, porcentajeRetenIVA,valorRetenIVA,porcentajeRetenFuente,valorRetenFuente)\n" +
"VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
        ...
        try {
            ...
            pst.setString(2, jTextFechVenFact.getText());
            String tipoDecompra = cmbTipoVentaVentFact.getSelectedItem().toString();
            pst.setString(3,tipoDecompra);
            pst.setString(4, jTextRucVenFact.getText());
            pst.setString(5, jTextRazCliVenFact.getText());
            pst.setString(6, jTextNumFacVenFact.getText());
            ...
            //porcentajeRetenIVA,valorRetenIVA,porcentajeRetenFuente,valorRetenFuente)\
            int porcentajeRetenIVA = Integer.parseInt(cmbPorcRetVentaFact.getSelectedItem().toString());
            String valor1 = calcularPorcentajeRetencionesIVA(jTextBase0VenFact.getText(),jTextBase12VenFact.getText(),cmbPorcRetVentaFact.getSelectedItem().toString());
            double valorRetenIVA = Double.parseDouble(valor1);
            double porcentajeRetenFuen = Double.parseDouble(cmbRetFuenVentaFact.getSelectedItem().toString());
            String valor2 = calcularRetencionesFuente(jTextBase0VenFact.getText(),jTextBase12VenFact.getText(),cmbRetFuenVentaFact.getSelectedItem().toString());
            double valorRetenFuente = Double.parseDouble(valor2);
            ...
            pst.setDouble(10, total);
             pst.setInt(11, porcentajeRetenIVA);
            pst.setDouble(12, valorRetenIVA);
            pst.setDouble(13, porcentajeRetenFuen);
            pst.setDouble(14, valorRetenFuente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeclaracionesVentasFacturaReg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeclaracionesVentasFacturaReg().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButRegNotasCred;
    private javax.swing.JButton jButVerTodFactura;
    private javax.swing.JButton jButVerTodNotasCred;
