 ...
 * @author Bryan
 */
public class DeclaracionesComprasFacturaReg extends javax.swing.JFrame {
     ...
     */
    public DeclaracionesComprasFacturaReg() {
        initComponents();
       ...
       TextPrompt fechPlHol= new TextPrompt("AAAA-MM-DD", jTextFechCompFact);
       TextPrompt rucPlHol= new TextPrompt("RUC de la factura", jTextRucCompFact);
       TextPrompt razSocPlHol= new TextPrompt("Razón Social de la factura", jTextRazSocCompFact);
       TextPrompt numFactPlHol= new TextPrompt("Número de la factura", jTextNumFacCompFact);
       TextPrompt base12PlHol= new TextPrompt("Valor de la base 12% de la factura", jTextBase12CompFact);
       TextPrompt base0PlHol= new TextPrompt("Valor de la base 0% de la factura", jTextBase0CompFact);
       ...
       jButRegFactComp.setEnabled(false);
    ...
    public String calcularIVA(String valorBase12){
     ...
     public boolean numeroUnicoFactura() throws SQLException
     {
         ...
         coneccion.hacerConexion();
                            String query = "Select * from FacturaCompras where numeroFacturaCompra = ?  ";
                            PreparedStatement pst = coneccion.conexion.prepareStatement(query);                     
                            pst.setString(1, jTextNumFacCompFact.getText());
                            ResultSet rs = pst.executeQuery();
                            if(rs.next()){
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Llena el formulario para registrar una Factura en Compras.");
        ...
        jButRegFactComp.setText("Registrar");
        ...
        cmbTipoCompraCompFact.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cmbTipoCompraCompFactMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                cmbTipoCompraCompFactMouseEntered(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                cmbTipoCompraCompFactMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                cmbTipoCompraCompFactMouseReleased(evt);
            }
        });
                    ...
                    .addGroup(PanelVerTodosLayout.createSequentialGroup()
                        .addGroup(PanelVerTodosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PanelVerTodosLayout.createSequentialGroup()
                                .addComponent(jlbl)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jIVA, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(51, 51, 51))
        );
...
Login login = new Login();
    ...
    private void jButVerTodNotasCreditoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButVerTodNotasCreditoActionPerformed
        DeclaracionesComprasNotaCreditoList lista = new DeclaracionesComprasNotaCreditoList();
    ...
    private void jButRegFactCompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButRegFactCompActionPerformed
        ...
        String query = "INSERT INTO FacturaCompras(idContribuyente, fecha, tipoCompra,ruc,razonSocial, numeroFacturaCompra, base12,iva,base0,total)\n" +
"VALUES (?,?,?,?,?,?,?,?,?,?);";
        ...
        try {
            ...
            pst.setString(2, jTextFechCompFact.getText());
            String tipoDecompra = cmbTipoCompraCompFact.getSelectedItem().toString();
            pst.setString(3,tipoDecompra);
            pst.setString(4, jTextRucCompFact.getText());
            pst.setString(5, jTextRazSocCompFact.getText());
            ...
            pst.setString(6, jTextNumFacCompFact.getText());
            ...
            coneccion.cerrarConexion();
            JOptionPane.showMessageDialog(null, "La Factura de Compra se registró exitosamente");
            ////////////BORRADO DE CAMPOS////////////////
                ...
                if(jTextFechCompFact.getText().length()!=0){
                    try {
                        if((fecha.esValidaFecha(jTextFechCompFact.getText())==true)){
                            ...
                            cmbTipoCompraCompFact.setEnabled(rootPaneCheckingEnabled);
 ...
 //////////////////////////VALIDAR UNIC Y ESTADO///////////////////////
                ...
                {   
                            ...
                            
                        {
                            if((DeclaracionesInicio.tomarRUCDECLARACIONES.equals(jTextRucCompFact.getText()))==false)
                            {
                                ...
                                {
                                    JOptionPane.showConfirmDialog(null,"No se puede registrar como proveedor siendo contribuyente");
                                }
                        }
                        else
                        {
    ...
    private void cmbTipoCompraCompFactMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbTipoCompraCompFactMouseEntered
        // TODO add your handling code here:
        
       
    }//GEN-LAST:event_cmbTipoCompraCompFactMouseEntered

    private void cmbTipoCompraCompFactMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbTipoCompraCompFactMousePressed
        // TODO add your handling code here:
         
       
    }//GEN-LAST:event_cmbTipoCompraCompFactMousePressed

    private void cmbTipoCompraCompFactMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbTipoCompraCompFactMouseReleased
        // TODO add your handling code here:
      
         
    }//GEN-LAST:event_cmbTipoCompraCompFactMouseReleased

    private void cmbTipoCompraCompFactMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbTipoCompraCompFactMouseClicked
        // TODO add your handling code here:
       
    }//GEN-LAST:event_cmbTipoCompraCompFactMouseClicked
    ...
    private void cmbTipoCompraCompFactItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbTipoCompraCompFactItemStateChanged
        // TODO add your handling code here:
           if(cmbTipoCompraCompFact.getSelectedIndex()!=0)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeclaracionesComprasFacturaReg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeclaracionesComprasFacturaReg().setVisible(true);
            }
        });
    }
