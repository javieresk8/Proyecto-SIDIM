 ...
 * @author Bryan
 */
public class DeclaracionesDeclarInicio extends javax.swing.JFrame {

    /**
     * Creates new form ContribuyentesPrincipal
     */
    public DeclaracionesDeclarInicio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Gestiona aquí las declaraciones del contribuyente.");
...
Login login = new Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeclaracionesDeclarInicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeclaracionesDeclarInicio().setVisible(true);
            }
        });
    }
